                        ...
                        window.onload=function(){
                                            ...
                                            // 1
                            let prenom_input=document.getElementById('form');
                            prenom_input.addEventListener('submit', function(e){
                                let prenom= document.getElementById("prenom");
                                if(prenom.value.trim()==""){
                                    let prenom_error= document.getElementById("error_1");
                                    prenom_error.innerHTML="Ce champ est obligatoire!";
                                    prenom_error.style.color='red';
                                    e.preventDefault();
                                }
                                        else if(penom.value.match('/[a-zA-Z0-9]{2,25}/')){
                                    let prenom_match= document.getElementById("error_1");
                           ...
                           input_confirm.addEventListener('submit',function(e){   
                                ...
                                if(confirmPwd.value.trim()==""){
                                    let confirmPwd_error= document.getElementById("error_5");
                                    ...
                                    let confirmPwd_match= document.getElementById("error_5");
                                ...
                                test. addEventListener('submit',function(e){
                                    ...
                                    let confirmPwd_test= document.getElementById("error_5");
